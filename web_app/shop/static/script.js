  ...
  updateAccountFavoritesPreview: function() {
    ...
    if (favorites.length === 0) {
      ...
      accountFavoritesContainer.innerHTML = `
        <div class="text-center py-8">
          <svg class="lucide lucide-heart mx-auto text-luxury-gray mb-3" fill="none" height="48" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="48" xmlns="http://www.w3.org/2000/svg">
            <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path>
          </svg>
          <p class="text-luxury-gray-dark mb-2">No favorites yet</p>
          <a href="/catalog/" class="text-luxury-gold hover:text-luxury-gold-dark text-sm font-medium">Browse collection</a>
        </div>
      `;
    } else {
