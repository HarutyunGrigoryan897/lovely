...
SECRET_KEY = 'django-insecure-n2i@-r7j4r(%_w&d@6a*9+thuvfs$#cni(h)05$5)wmebxk=+g'
...
MIDDLEWARE = [
    ...
    'authorization.telegram_only_middleware.TelegramOnlyMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'shop.context_processors.user_pricing',  # User level pricing
            ],
        },
    },
]
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "authorization.bot_authentication.BotAuthentication",
    ]
}